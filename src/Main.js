...
const Main = () => {
  ...
  const scrollToServices = () => scrollToElement(servicesRef, 100);
  const scrollToPortfolio = () => scrollToElement(portfolioRef, 100);
  const scrollToPrices = () => scrollToElement(pricesRef, 100);
  const scrollToMap = () => scrollToElement(mapRef, 100);
  const scrollToTeach = () => scrollToElement(teachRef, 100);
  ...
  return (
    <div>
          ...
          <div className="header-content" ref={menuRef}>
            ...
            <div className="header-button">
              ...
              <button
                ...
                className="btn header-contact-btn"
              >
                {t("contact")}
              </button>
      ...
      <ModalWindow show={showModal} onClose={handleCloseModal}>
        ...
        <p style={{ fontSize: "25px" }}>{t("modal")}</p>
      </ModalWindow>
      ...
      <section className="welcome__container">
        <div className="welcome-block ">
          <div className="first-block">
            <h1>
              {t("hairdresser")} <span className="title">{t("stylist")}</span>
            </h1>

            <h2 style={{ marginBottom: "7%", marginTop: "7%" }}>
              {t("create")}{" "}
              <span style={{ color: "#4824ff" }}>{t("best")}</span>
              <br />
              {t("unique")}
              <span style={{ color: "#4824ff" }}> {t("image")} </span>
              <br />
              {t("style")} <span style={{ color: "#4824ff" }}>{t("you")}</span>
            </h2>

            <h3>
              {t("work")} <span style={{ color: "#4824ff" }}>{t("year")}</span>
            </h3>
          </div>
      ...
      <section className="service__container" ref={servicesRef}>
        <div className="service-block " draggable="false">
          <h2
            ...
            style={{ fontSize: "clamp(1.25rem, 0.523rem + 3.64vw, 3.25rem)" }}
          >
            {t("services")}
          </h2>
          ...
          <p style={{ fontSize: "27px" }}>
            Для запису пишіть у повідомлення або телефонуйте
          </p>
      ...
      <section className="portfolio-section" ref={portfolioRef}>
        <div className="portfolio-head __slider">
          <div className="first-block">
        ...
        <div className="portfolio-fullbleed full-bleed">
      ...
      <section className="price__container" ref={pricesRef}>
        <div className="price-block __container" draggable="false">
          <h3
            ...
            style={{ fontSize: "clamp(2.5rem, 1.136rem + 6.82vw, 6.25rem)" }}
          >
            {t("prices")}
          </h3>
          ...
          <div className="content-block">
            <div className="vertical-video-container">
              <video className="vertical-video" controls>
                <source
                  src={`${process.env.PUBLIC_URL}/video/maps.mp4`}
                  type="video/mp4"
                />
  ...
  src="https://www.google.com/maps?q=VN%20Hair%20Studio&output=embed"
  allowFullScreen
  loading="lazy"
...
></iframe>
        ...
        <div className="card-container">
          <div className="card card--barber">
            ...
            <ul className="guarantees-points">
              <li className="point">
                <span className="icon">✂️</span> {t("fade")}
              </li>
              <li className="point">
                <span className="icon">📖</span> {t("teorie")}
              </li>
              <li className="point">
                <span className="icon">👱‍♂️</span> {t("analyza")}
              </li>
              <li className="point">
                <span className="icon">💡</span> {t("tipy")}
              </li>
              <li className="point">
                <span className="icon">✅</span> {t("zkouska")}
              </li>
              <li className="point">
                <span className="icon">🚀</span> {t("start")}
              </li>
            </ul>
          ...
          <div className="card card--female">
            ...
            <ul className="guarantees-points">
              <li className="point">
                <span className="icon">✂️</span> {t("znalosti")}
              </li>
              <li className="point">
                <span className="icon">🕢</span> {t("praxe")}
              </li>
              <li className="point">
                <span className="icon">🤵‍♀️</span> {t("vyber")}
              </li>
              <li className="point">
                <span className="icon">🧑‍🧑‍🧒‍🧒</span> {t("komunikace")}
              </li>
              <li className="point">
                <span className="icon">✅</span> {t("zkouska")}
              </li>
              <li className="point">
                <span className="icon">🚀</span> {t("kadernici")}
              </li>
            </ul>
            <div className="price__teach">
              {t("cena")}: 12000 Kč <span className="price__icon"></span>
          ...
          <div className="card card--combo">
            ...
            <ul className="guarantees-points">
              <li className="point">
                <span className="icon">📘</span> {t("techniky")}
              </li>
              <li className="point">
                <span className="icon">✂️</span> {t("mikado")}
              </li>
              <li className="point">
                <span className="icon">👥</span> {t("modelech")}
              </li>
              <li className="point">
                <span className="icon">📝</span> {t("samostatna")}
              </li>
              <li className="point">
                <span className="icon">✅</span> {t("certifikat")}
              </li>
              <li className="point">
                <span className="icon">🚀</span> {t("jistita")}
              </li>
            </ul>
            <div className="price__teach">
      ...
      <section
        className="online-course-section"
        id="online-course"
        ref={onlineCourseRef}
      >
          ...
          <div className="online-course__card-wrapper">
            <div className="card card--online">
              ...
              <p className="online-course__subtitle">
                Доступ до всіх уроків VN Hair Studio в онлайн-форматі: відео,
                теорія, домашні завдання та підтримка в особистому кабінеті.
              </p>

              <ul className="guarantees-points">
                <li className="point">
                  <span className="icon">🎥</span> Записані уроки у високій якості
                </li>
                <li className="point">
                  <span className="icon">📚</span> Теорія, схеми та PDF-матеріали
                </li>
                <li className="point">
                  <span className="icon">📝</span> Домашні завдання з розбором
                </li>
                <li className="point">
                  <span className="icon">💬</span> Підтримка та відповіді на запитання
                </li>
                <li className="point">
                  <span className="icon">🔐</span> Особистий кабінет з логіном і паролем
                </li>
              </ul>
      ...
      {isCourseLoginOpen && (
        <div className="course-login__backdrop" onClick={closeCourseLogin}>
          ...
          >
            ...
            <p className="course-login-card__subtitle">{t("signin")}</p>
